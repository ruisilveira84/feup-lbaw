...
<html lang="en">
    ...
    <!-- Top Sidebar -->
        <div class="top-sidebar">
            ...
            <form action="{{ route('auction.search') }}" method="GET" class="search-container">
            ...
            <a href="{{ route('createauction') }}"><button>Create Auction</button></a>

            <a href="{{ url('/profile') }}">
                <button class="avatar-button">
                    <img src="{{url('avatar.png')}}" alt="Avatar" class="avatar" style="max-width: 60px;">
                </button>
            </a>

            <a href="{{ url('/logout') }}">
                <button class="door-button">
                    <img src="{{url('door.png')}}" alt="Logout" class="door" style="max-width: 40px;">
                    <div class="door-text">LOGOUT</div>
                </button>
            </a>

            @endauth
            
            <!-- Janela Modal para o Filtro -->
            <div id="filterModal" class="modal">
                <div class="modal-content">
                    ...
                    <select id="auctionStatus" name="auctionStatus">
...
@section('bottom-sidebar')
        ...
        <div class="bottom-sidebar">
            <a href="{{ url('/aboutus') }}"><button>About us</button></a>
            <a href="{{ url('/contacts') }}"><button>Contacts</button></a>
            <!-- <a href="{{ url('/support') }}"><button>Support</button></a> -->
            <a href="{{ route('terms') }}"><button>Terms of Service</button></a>
